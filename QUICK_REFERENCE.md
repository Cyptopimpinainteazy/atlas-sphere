...
| File | Purpose |
|------|---------|
| `SETUP_SUMMARY.md` | Complete overview (you are here) |
| `BOOT_AND_AUTH_SETUP.md` | Detailed boot & auth guide |
| `E2E_SECURITY_TESTING.md` | Testing guide & debugging |
...
|---------|--------------|
| How to start services? | `BOOT_AND_AUTH_SETUP.md` |
| How to run tests? | `E2E_SECURITY_TESTING.md` |
| Test failing? | `E2E_SECURITY_TESTING.md` → Debugging section |
| Boot auto-start issue? | `BOOT_AND_AUTH_SETUP.md` → Troubleshooting |
| Complete overview? | `SETUP_SUMMARY.md` (you are here) |
