...
const _lazy_Ze2SjS = () => Promise.resolve().then(function () { return _____$1; });
...
const handlers = [
  ...
  { route: '/api/**', handler: _lazy_Ze2SjS, lazy: true, middleware: false, method: undefined },
...
const _____ = defineEventHandler(async (event) => {
  const backendUrl = process.env.NUXT_BACKEND_URL;
  if (!backendUrl) {
    throw new Error("NUXT_BACKEND_URL is not defined");
  }
