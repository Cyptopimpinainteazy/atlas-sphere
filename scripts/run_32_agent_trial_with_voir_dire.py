...
from swarm.jury import JuryManager, VoirDireManager, LawyerRole, StrikeReason
...
class Trial32AgentRunner:
    ...
    def __init__(self, trial_name: str = "32-agent-trial-001"):
        ...
        print(f"   Governance Model: Voir Dire (Anonymized, Dual-Counsel, Randomized)")
        print()
    ...
    def run_cohort_a_self_model(self) -> Dict:
        ...
        print(f"  Version consistency: 100%")
        print()
    ...
    def run_cohort_b_goal_genome(self) -> Dict:
        ...
        print(f"  Mutation integrity: 100%")
        print()
    ...
    def run_cohort_d_governance_with_voir_dire(self) -> Dict:
        ...
        for agent_id in range(25, 33):
            ...
            try:
                ...
                success, seated, excluded = self.voir_dire_manager.finalize_empanelment(voir_dire_id=voir_dire_id, jury_size=6)
                
                if success:
                    # Create jury session
                    jury_members = [JuryMember(agent_id=f"juror-{i}", section="general", is_on_chain=False)
                                   for i in range(6)]
        ...
        print(f"  Governance actions: operational")
        print()
...
"""
    ...
    def run(self):
        ...
        bias_analysis = self.analyze_bias_patterns()
