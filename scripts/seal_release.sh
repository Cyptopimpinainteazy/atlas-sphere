...
cat > "$SEAL_FILE" <<EOF
{
  ...
  "attestation": "This repository has been audited by the nuclear finisher stack and meets all hard gates: zero TODOs, zero vulnerabilities, full integration, verified symmetry."
}
EOF
