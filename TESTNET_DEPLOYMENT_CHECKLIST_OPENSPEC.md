...
- [ ] 2.6 Verify RPC methods work locally (see `TESTNET_QUICKSTART.md`)
...
- [ ] 14.5 Test Atlas Kernel RPC methods (see `TESTNET_QUICKSTART.md`)
...
- [ ] 19.1 Review `TESTNET_ANNOUNCEMENT.md` for accuracy
...
- [ ] 21.1 Publish `TESTNET_QUICKSTART.md` to docs site
