...
| **Integration Guide** | `TIER8-DORKS-FRONTEND-INTEGRATION.md` | 300+ | useDorksSearch(), useFundingPipeline(), component examples |
...
1. Read complete guide: `TIER8-DORKS-FRONTEND-INTEGRATION.md`
