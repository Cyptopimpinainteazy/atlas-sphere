...
### Evening: Test Sfrontend/uite (2-3 hours)
...
- [ ] Complete test sfrontend/uite (writer, reader, storage, integration)
...
- [ ] GetStats()
- [ ] Complete test sfrontend/uite (all edge cases)
...
- [ ] Complete test sfrontend/uite (all edge cases, concurrent writes)
...
go bfrontend/uild ./internal/genesis/...           # ✓
go bfrontend/uild ./internal/ledger/...            # ✓
go bfrontend/uild ./internal/capability/...        # ✓
go bfrontend/uild ./internal/operator/...          # ✓
```
