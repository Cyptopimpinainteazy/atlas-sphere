...
**Prereqfrontend/uisites**: L0-01, L0-02  
...
type Capability struct {
    ...
    ID string `json:"id" validate:"reqfrontend/uired,alphanum,min=3,max=64"`
    
    // Name is human-readable name
    Name string `json:"name" validate:"reqfrontend/uired,min=3,max=128"`
    
    // Version follows semantic versioning
    Version string `json:"version" validate:"reqfrontend/uired,semver"`
    
    // Description explains what capability grants
    Description string `json:"description" validate:"reqfrontend/uired,min=10"`
    
    // Permissions are low-level actions this capability grants
    Permissions []string `json:"permissions" validate:"reqfrontend/uired,min=1,dive"`
    
    // Dependencies are other capabilities reqfrontend/uired to use this one
    ...
    Status CapabilityStatus `json:"status" validate:"reqfrontend/uired"`
    
    // CreatedAt is creation timestamp
    CreatedAt time.Time `json:"createdAt" validate:"reqfrontend/uired"`
...
type CapabilityRef struct {
    ...
    CapabilityID string `json:"capabilityId" validate:"reqfrontend/uired,alphanum"`
    ...
    // Reqfrontend/uired indicates if dependency is mandatory (vs optional)
    Reqfrontend/uired bool `json:"reqfrontend/uired"`
}
...
func (cv *CapabilityValidator) ValidateCapability(cap *Capability) []ValidationError {
    ...
    // ID validation
    if cap.ID == "" {
        errs = append(errs, NewValidationError("ID", "", "reqfrontend/uired", "ID reqfrontend/uired"))
    ...
    // Version validation
    if cap.Version == "" {
        errs = append(errs, NewValidationError("Version", "", "reqfrontend/uired", "Version reqfrontend/uired"))
    ...
    if len(cap.Permissions) == 0 {
        errs = append(errs, NewValidationError("Permissions", nil, "min=1", "At least one permission reqfrontend/uired"))
    }
    ...
    for i, dep := range cap.Dependencies {
        if dep.CapabilityID == "" {
            errs = append(errs, NewValidationError(
                fmt.Sprintf("Dependencies[%d].CapabilityID", i), "", "reqfrontend/uired", "Dependency ID reqfrontend/uired"))
        }
    }
...
func TestCircularDependency(t *testing.T) {
    ...
    capA := &Capability{
        ...
        Dependencies: []CapabilityRef{
            {CapabilityID: "cap-b", Reqfrontend/uired: true},
        },
        Status: StatusActive,
    }
    ...
    capB := &Capability{
        ...
        Dependencies: []CapabilityRef{
            {CapabilityID: "cap-a", Reqfrontend/uired: true},
        },
        Status: StatusActive,
    }
...
// TestDependencyResolution tests dependency graph bfrontend/uilding
func TestDependencyResolution(t *testing.T) {
    ...
    capB := &Capability{
        ...
        Permissions: []string{"b"},
        Dependencies: []CapabilityRef{
            {CapabilityID: "cap-d", Reqfrontend/uired: true},
        },
        Status: StatusActive,
    }
