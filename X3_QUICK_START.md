# X3 Development: Qfrontend/uick Start Gfrontend/uide
...
See `/home/lojak/Desktop/atlas-sphere-master/X3_MILESTONE_TRACKING.md`
...
### Your Next Steps
1. ✅ Review X3_MILESTONE_TRACKING.md
...
| What | Where |
|------|-------|
| Master Milestones | `/X3_MILESTONE_TRACKING.md` |
...
```bash
1. Pick task from X3_MILESTONE_TRACKING.md
...
| Problem | Who | How |
|---------|-----|-----|
| Unclear reqfrontend/uirement | @protocol-core | Comment on GitHub issue |
...
1. Check `/X3_MILESTONE_TRACKING.md` for the big picture
...
**Good luck bfrontend/uilding X3. Make it boring. Make it correct. Make it survive.** 🚀
