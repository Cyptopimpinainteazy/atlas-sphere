...
impl DexRouter {
    pub fn new(name: impl Into<String>, protocol: impl Into<String>, router: impl Into<String>) -> Self {
        Self {
            name: name.into(),
    ...
    RpcRegistry::new()
        ...
        .register(
            ChainRpcConfig::new(8453, "Base Mainnet")
                ...
                .add_rpc(RpcEndpoint::new("https://base-mainnet.g.alchemy.com/v2/Fe5T2pGsX76ml9kDCwVRZhtmkdixfrDQ").with_priority(90))
        ...
        .register(
            ChainRpcConfig::new(43114, "Avalanche C-Chain")
                .add_rpc(RpcEndpoint::new("https://api.avax.network/ext/bc/C/rpc").with_priority(100))
...
mod tests {
    ...
    fn test_flashloan_provider() {
        let provider = FlashLoanProvider::new("Aave V3", "0x123", 5)
