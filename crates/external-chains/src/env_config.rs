...
impl EnvConfig {
    ...
    pub fn new(network: NetworkEnv) -> Self {
        ...
        match network {
            NetworkEnv::Arbitrum => {
                rpc_urls.insert("primary".to_string(), vec![
                    "https://arb-mainnet.g.alchemy.com/v2/Fe5T2pGsX76ml9kDCwVRZhtmkdixfrDQ".to_string(),
                ]);
            ...
            NetworkEnv::Base => {
                rpc_urls.insert("primary".to_string(), vec![
                    "https://base-mainnet.g.alchemy.com/v2/Fe5T2pGsX76ml9kDCwVRZhtmkdixfrDQ".to_string(),
                ]);
                rpc_urls.insert("fallback".to_string(), vec![
    ...
    pub fn from_env() -> Self {
        ...
        config.provider_credentials = ProviderCredentials::new()
            ...
            .with_ankr("648269110992d35fb12b490f3e9d00e18141ad9212081909344f15ec1c342a3c".to_string());
