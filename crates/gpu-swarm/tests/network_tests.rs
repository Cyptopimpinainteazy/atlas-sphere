...
#[cfg(test)]
mod network_tests {
    use gpu_swarm::network::{NetworkManager, NetworkConfig, PeerId};
    ...
    async fn test_healthy_peers_filtering() {
        ...
        let good_peer = manager
            .connect("/ip4/127.0.0.1/tcp/9003")
            .await
            .unwrap();
        ...
        // Add a bad peer
        let bad_peer = manager
            .connect("/ip4/127.0.0.1/tcp/9004")
            .await
            .unwrap();
    ...
    async fn test_peer_discovery() {
        ...
        discovery.add_peer(
            peer_id,
            vec!["/ip4/127.0.0.1/tcp/9010".to_string()],
        );
    ...
    fn test_connection_manager() {
        use gpu_swarm::network::{ConnectionManager, ConnectionDirection};
