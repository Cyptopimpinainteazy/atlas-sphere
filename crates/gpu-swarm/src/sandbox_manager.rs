...
impl SandboxManager {
    ...
    pub fn create(
        ...
        let id = format!("sb-{}", uuid::Uuid::new_v4().to_string().split('-').next().unwrap_or("0"));
...
mod tests {
    ...
    fn create_and_start_sandbox() {
        ...
        let id = mgr
            .create([0x01; 16], IsolationLevel::Container, ResourceLimits::default())
            .unwrap();
    ...
    fn checkpoint_and_resume() {
        ...
        let id = mgr
            .create([0x01; 16], IsolationLevel::MigPartition, ResourceLimits::default())
            .unwrap();
        mgr.start(&id).unwrap();
    ...
    fn capacity_enforced() {
        ...
        mgr.create([0x01; 16], IsolationLevel::Container, ResourceLimits::default())
            .unwrap();

        let result = mgr.create([0x02; 16], IsolationLevel::Container, ResourceLimits::default());
