...
impl IntentLifecycle {
    ...
    pub fn finalize(
        ...
        let result = intent.result.as_ref()
        ...
        let fee_paid = intent.route.as_ref()
            .map(|r| r.fee.total)
            .unwrap_or(0);
...
mod tests {
    ...
    fn test_full_lifecycle() {
        ...
        let mut intent = IntentLifecycle::submit_intent(
            ...
            test_agent(),
            [0xAA; 32],
            IntentFlags { slashable: true, ..Default::default() },
            1_000_000,
            1_000_000,
            100,
            50,
        ...
        IntentLifecycle::complete_execute(&mut intent, ExecutionResult {
            success: true,
