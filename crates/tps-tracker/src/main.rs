/// Atlas Sphere TPS Tracker Binary
/// 
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let config = TpsTrackerConfig {
        ...
        influx_db: env::var("INFLUX_DB").unwrap_or_else(|_| "atlas_sphere_tps".to_string()),
        influx_token: env::var("INFLUX_TOKEN").unwrap_or_else(|_| "atlas-sphere-key".to_string()),
