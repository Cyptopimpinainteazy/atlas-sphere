...
fn test_validator_creation() {
    ...
    assert_eq!(validator.state(), x3_gpu_validator_swarm::validator::ValidatorState::Starting);
}
...
fn test_validator_initialization() {
    ...
    assert_eq!(validator.state(), x3_gpu_validator_swarm::validator::ValidatorState::Running);
}
...
fn test_validator_cpu_mode() {
    ...
    assert_eq!(validator.current_mode(), ExecutionMode::GpuWithCpuVerification);
}
