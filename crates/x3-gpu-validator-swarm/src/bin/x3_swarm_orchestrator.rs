...
async fn run_orchestrator() {
    ...
    println!("Assignment strategy: {:?}", orchestrator.get_all_validator_metrics().len());
    ...
    println!("Registered {} validators", orchestrator.get_active_validators());
...
async fn run_benchmark() {
    ...
    println!("{:<15} {:<15} {:<15} {:<15}", "Task Count", "Pending", "Processed", "Time (ms)");
    println!("{}", "-".repeat(60));
