...
impl QuarantineManager {
    ...
    pub fn new(max_divergence_count: u32, quarantine_duration_secs: u64, auto_fallback_cpu: bool) -> Self {
        Self {
    ...
    pub fn get_stats(&self) -> QuarantineStats {
        ...
        let active = quarantined.values().filter(|e| !e.is_expired() && !e.permanent).count();
