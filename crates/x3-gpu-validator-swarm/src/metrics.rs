...
impl MetricsCollector {
    ...
    pub fn get_counter(&self, name: &str) -> u64 {
        ...
        counters.get(name).map(|c| c.load(Ordering::SeqCst)).unwrap_or(0)
    }
    ...
    pub fn record_task(&self, validator_id: &str, latency_ms: u64, success: bool, divergent: bool) {
        ...
        // Update validator metrics
        {
            ...
            let metrics = validators.entry(validator_id.to_string()).or_insert_with(|| ValidatorMetrics {
            ...
            metrics.avg_latency_ms = (total_latency + latency_ms as f64) / metrics.tasks_completed as f64;
        }
    ...
    pub fn export_json(&self) -> SwarmResult<String> {
        ...
        let data = ExportData {
            ...
            counters: self.counters.read().iter()
