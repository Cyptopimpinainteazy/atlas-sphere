...
impl TelemetrySink {
    ...
    /// Record an event
    pub fn record(&self, event_type: String, validator_id: String, data: HashMap<String, serde_json::Value>) {
    ...
    pub fn record_metrics(&self, validator_id: String, metrics: &SwarmMetrics) {
        ...
        data.insert("total_tasks".to_string(), serde_json::json!(metrics.total_tasks));
        data.insert("successful_tasks".to_string(), serde_json::json!(metrics.successful_tasks));
        data.insert("failed_tasks".to_string(), serde_json::json!(metrics.failed_tasks));
        data.insert("divergent_tasks".to_string(), serde_json::json!(metrics.divergent_tasks));
        data.insert("cpu_fallbacks".to_string(), serde_json::json!(metrics.cpu_fallbacks));
        data.insert("avg_task_latency_ms".to_string(), serde_json::json!(metrics.avg_task_latency_ms));
        data.insert("tasks_per_second".to_string(), serde_json::json!(metrics.tasks_per_second));
