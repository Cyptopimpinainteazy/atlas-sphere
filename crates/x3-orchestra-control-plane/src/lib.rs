...
pub use types::{
    ...
    Intent, IntentDispatchRequest, IntentKind, IntentStatus, NewApprovalCase,
    NewIntent, NewRewardAccrual, NewVoteReceipt, NewVoteWindow, RewardAccrual,
    RewardAccrualStatus, RiskClass, VoteChoice, VoteReceipt, VoteTally, VoteWindow,
    VoteWindowStatus,
};