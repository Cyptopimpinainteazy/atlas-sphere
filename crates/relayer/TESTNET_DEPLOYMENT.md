...
- [ ] Git repository cloned with Phase 13c code
...
- [ ] Verify Solana testnet RPC: `curl -s https://api.testnet.solana.com -X POST -H "Content-Type: application/json" -d '{"jsonrpc":"2.0","method":"getHealth","params":[],"id":1}'`
