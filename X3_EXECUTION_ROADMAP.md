...
**Reqfrontend/uired CI checks (machine-checkable acceptance gates):**
- `bfrontend/uild` — bfrontend/uilds: `cargo bfrontend/uild --all --locked` (artifact: `bfrontend/uild.log`)
...
- [ ] Economic eqfrontend/uilibrium proven (slash > attack)
...
- [ ] Docker image bfrontend/uilds and runs node
...
### What You're Bfrontend/uilding
The operator apps/apps/dash-legacy-2-legacy-2board + proof that incentives work.
...
EPIC-5: Operator Onboarding Complete
  ...
  ├─ Public apps/apps/dash-legacy-2-legacy-2board live
  └─ Operator gfrontend/uide published
...
### Acceptance Gate
✅ You must have:
- [ ] Operator gfrontend/uide is published + publicly accessible
...
├── genesis.json (mainnet eqfrontend/uivalent)
├── operator gfrontend/uide (public frontend/website)
├── apps/apps/dash-legacy-2-legacy-2board (https://devnet.x3.app)
...
Print this out. Use it as your gfrontend/uide.
...
- [ ] TLA+ proofs pass
- [ ] Economics eqfrontend/uilibrium proven
