...
Example: `/prp-poc-create-parallel 5 "create a apps/dash-legacy-2-legacy-2board for tracking team productivity with real-time metrics"`
...
```yaml
poc_name: "poc-{problem-slug}-apps/dash-legacy-2-legacy-2board-mobile"
...
fidelity: "Demo"
unique_aspects: "Analytics apps/dash-legacy-2-legacy-2board optimized for mobile devices"
```
...
│   ├── poc-{problem-slug}-apps/dash-legacy-2-legacy-2board-mobile/
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/apps/dash-legacy-2-legacy-2board-mobile" element={<POCDashboardMobile />} />
