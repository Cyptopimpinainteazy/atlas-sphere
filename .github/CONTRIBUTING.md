...
- Playwright e2e includes a small axe-core accessibility scan. If violations are detected, a file `apps/swarm-dashboard/e2e/axe-violations.json` is produced and uploaded by CI.
