...
const sites = {
  ai:              { title: "X3 AI",             tagline: "Artificial Intelligence Platform",   icon: "🤖", color: "#8B5CF6", description: "Neural networks, model training, and AI-powered tools for the X3 ecosystem.", status: "Coming Soon", tauri: "apps/atlas-desktop — AI panels & eyeball components" },
  chat:            { title: "X3 Chat",           tagline: "Decentralized Messaging",            icon: "💬", color: "#06B6D4", description: "End-to-end encrypted messaging powered by the Atlas blockchain.", status: "Coming Soon", tauri: "apps/atlas-desktop/src/pages/social/MessagesPage.tsx" },
  social:          { title: "X3 Social",         tagline: "Web3 Social Network",                icon: "🌐", color: "#EC4899", description: "Connect, share, and earn. Your social graph, on-chain.", status: "Coming Soon", tauri: "apps/atlas-desktop/src/pages/social/SocialApp.tsx" },
  ...
  blockchain:      { title: "X3 Blockchain",     tagline: "Network Dashboard",                  icon: "⛓️", color: "#3B82F6", description: "Real-time block production, finality, and network health.", status: "Coming Soon", tauri: "apps/atlas-desktop — system metrics components" },
  ...
  ide:             { title: "X3 IDE",            tagline: "Online Development Environment",     icon: "🖥️", color: "#64748B", description: "Write, compile, and deploy X3 smart contracts in your browser.", status: "Coming Soon", tauri: "crates/x3-compiler, crates/atlas-lsp" },
  ...
  docs:            { title: "X3 Docs",           tagline: "Documentation & Guides",             icon: "📚", color: "#6366F1", description: "Developer documentation, API references, and tutorials.", status: "Coming Soon", tauri: "apps/atlas-desktop/src/components/documentation" },
  ...
  "x-change":      { title: "X3 Exchange",       tagline: "Decentralized Exchange",             icon: "💱", color: "#14B8A6", description: "Swap any token across chains with minimal slippage.", status: "Coming Soon", tauri: "apps/3ai/dex, crates/atlas-swap-router" },
  ...
  wallet:          { title: "X3 Wallet",         tagline: "Web3 Wallet",                        icon: "👛", color: "#7C3AED", description: "Non-custodial multi-chain wallet in your browser.", status: "Coming Soon", tauri: "apps/atlas-desktop — wallet components" },
  ...
  pics:            { title: "X3 Pics",           tagline: "Image Gallery & Hosting",            icon: "🖼️", color: "#C026D3", description: "Upload, share, and monetize images on IPFS.", status: "Coming Soon", tauri: "apps/atlas-desktop/src/pages/social/PhotosPage.tsx" },
  ...
  explorer:        { title: "X3 Explorer",       tagline: "Block Explorer",                     icon: "🔎", color: "#1D4ED8", description: "The original Atlas block explorer.", status: "Coming Soon" },
};
