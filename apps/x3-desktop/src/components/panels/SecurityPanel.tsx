...
function mockAttestations(): AttestationRecord[] {
  return [
    { provider: "x3-gpu-0", hardware: "RTX 4090 24GB", tpm: true, sgxSupport: true, lastAttest: "3min ago", result: "passed" },
    { provider: "x3-gpu-1", hardware: "RTX 3090 24GB", tpm: true, sgxSupport: false, lastAttest: "8min ago", result: "passed" },
