# Atlas Desktop - App Startup Guide

This guide helps you launch all the applications that appear in the Atlas Desktop dock and ensure they're wired with real data.
...
The Atlas Desktop dock includes these apps that need to be running on specific ports:
...
- **RPC Node**: `http://127.0.0.1:9944` (Atlas Kernel)
