# Atlas Desktop - Complete Ship & Test Documentation Index
...
### Before Deployment
- [ ] Run: `cd apps/atlas-desktop && npm run test`
...
./ src-tauri/target/release/atlas-desktop
```
...
# Find errors
grep -i error ~/.atlas-desktop/logs/main.log
...
- **"How do I run E2E tests?"** → tests/e2e/README.md
