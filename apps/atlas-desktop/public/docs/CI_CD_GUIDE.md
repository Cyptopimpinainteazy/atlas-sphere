...
**URL**: `https://staging-dashboard.atlas-sphere.com`
...
**URL**: `https://dashboard.atlas-sphere.com`
...
```env
VITE_API_BASE_URL=https://staging-api.atlas-sphere.com/api
VITE_WS_BASE_URL=wss://staging-api.atlas-sphere.com/ws
...
```env
VITE_API_BASE_URL=https://api.atlas-sphere.com/api
VITE_WS_BASE_URL=wss://api.atlas-sphere.com/ws
...
- **REST API**: `https://api.atlas-sphere.com/api`
- **WebSocket**: `wss://api.atlas-sphere.com/ws`

### Health Checks

```bash
# API health
curl https://api.atlas-sphere.com/api/health

# Dashboard health
curl https://dashboard.atlas-sphere.com/health
```
