...
Value: staging.atlas-sphere.com (or your staging server hostname/IP)
```
...
Value: api.atlas-sphere.com (or your production server hostname/IP)
```
...
Value: https://sonarqube.atlas-sphere.com
```
...
```bash
# From local machine
ssh -i staging-deploy ubuntu@staging.atlas-sphere.com "echo 'SSH works!'"
```
