...
export const DEFAULT_APPLICATIONS: Application[] = [
  ...
  },
  {
    id: "x3-agents",
    name: "X3 Agents",
    description: "Agent management — reputation, bonds, execution stats, slashes",
    category: "analysis",
    icon: { type: "placeholder", category: "analysis", color: "#4488ff" },
    launchCommand: { type: "internal", target: "x3-agents" },
  },
  {
    id: "x3-bonds",
    name: "X3 Bonds",
    description: "Bond management — deposit, withdraw, lock status, history",
    category: "defi",
    icon: { type: "placeholder", category: "defi", color: "#00d4aa" },
    launchCommand: { type: "internal", target: "x3-bonds" },
  },
  {
    id: "x3-guide",
    name: "X3 Guide",
    description: "Getting started with X3 Intelligence — agent registration, rules",
    category: "utility",
    icon: { type: "placeholder", category: "utility", color: "#7c4dff" },
    launchCommand: { type: "internal", target: "x3-guide" },
  },
  {
    id: "x3-intents",
    name: "X3 Intents",
    description: "Intent explorer — state tracking, legs, fees, execution proofs",
    category: "analysis",
    icon: { type: "placeholder", category: "analysis", color: "#4488ff" },
    launchCommand: { type: "internal", target: "x3-intents" },
  },
  {
    id: "x3-slashing",
    name: "X3 Slashing",
    description: "Slashing events — severity, amounts, proofs, accountability",
    category: "security",
    icon: { type: "placeholder", category: "security", color: "#ff4444" },
    launchCommand: { type: "internal", target: "x3-slashing" },
  },
  {
    id: "x3-why",
    name: "Why X3?",
    description: "Why X3 Intelligence — deterministic arbitrage, agent economy",
    category: "utility",
  ...
  },
  {
    ...
    description: "Manage liquidity positions — TVL, APR, pool analytics",
    category: "defi",
