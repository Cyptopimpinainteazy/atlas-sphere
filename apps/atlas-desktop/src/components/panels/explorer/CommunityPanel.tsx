...
const sections = [
  {
    title: "Forum",
    description: "Join discussions, ask questions, and share ideas with the Atlas Sphere community.",
    icon: MessageSquare,
    gradient: "from-indigo-500 to-purple-500",
  },
  {
    title: "Ecosystem Directory",
    description: "Explore projects, dApps, and tools built on Atlas Sphere.",
    icon: Globe,
    gradient: "from-cyan-500 to-blue-500",
  },
  {
    title: "Grants Program",
    description: "Apply for funding to build on Atlas Sphere. Up to $50K per project.",
    icon: Gift,
...
const featuredProjects = [
  { name: "X3 Swap", stat: "$45M TVL", description: "Decentralized exchange on Atlas Sphere", tag: "DeFi" },
  { name: "Atlas NFT", stat: "10K+ Collections", description: "NFT marketplace and launchpad", tag: "NFT" },
  ...
  return (
    <div className="overflow-y-auto h-full bg-gradient-to-b from-slate-900 via-[#0d0a14] to-black text-white p-6 space-y-8">
      ...
      <div>
        ...
        <p className="text-slate-400 text-sm mt-1">Connect, build, and grow with Atlas Sphere</p>
      </div>
