      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            By accessing or using the Atlas Sphere network, decentralized applications, website, or any related
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            Atlas Sphere provides a decentralized blockchain network with support for smart contracts, cross-chain
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            To the maximum extent permitted by law, Atlas Sphere and its contributors, developers, and affiliates
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            The Atlas Sphere protocol is open-source software licensed under applicable open-source licenses.
            Trademarks, logos, and branding remain the property of Atlas Sphere and may not be used without
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            ...
            Atlas Sphere operates, without regard to conflict of law principles.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-orange-400 font-medium">legal@atlas-sphere.io</p>
        </section>

        <div className="border-t border-slate-800 pt-4 text-xs text-slate-600 text-center">
          &copy; 2026 Atlas Sphere. All rights reserved.
        </div>
      </div>
    </div>
  );
