...
const predictions = [
  { id: 'pred-01', question: 'ATLAS > $50 by Q2 2026?', yesPrice: 0.62, volume: 125000, endDate: 'Jun 30, 2026' },
  ...
  { id: 'pred-04', question: 'Atlas mainnet TPS > 10,000?', yesPrice: 0.33, volume: 62000, endDate: 'May 01, 2026' },
];
...
const X3SubPagesPanel: React.FC = () => {
  ...
  const handleRun = () => {
    setScriptOutput('> Executing script...\n> Connected to Atlas devnet (127.0.0.1:9944)\n> EVM Balance: 142.58 ATLAS\n> SVM Balance: 89.32 ATLAS\n> Script completed in 0.34s');
  };
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-[#1a1a1a] text-gray-500 text-xs uppercase tracking-wider">
                      ...
                      <th className="text-right px-4 py-2.5">Earnings (ATLAS)</th>
                    </tr>
                  </thead>
                  <tbody>
                    {gpuNodes.map(n => (
                ...
                {auctions.map(a => (
                  <div key={a.id} className="p-4 bg-[#111118] border border-[#1a1a1a] rounded-lg">
                    ...
                    <div className="grid grid-cols-4 gap-4 text-xs">
                      ...
                      <div><span className="text-gray-500">Bid Floor</span><p className="text-gray-300">{a.bidFloor} ATLAS</p></div>
                      <div><span className="text-gray-500">Top Bid</span><p className="text-[#ff6b35] font-semibold">{a.topBid} ATLAS</p></div>
