  ...
  return (
    <div className="flex flex-col h-full bg-[#0a0a0f] text-gray-300">
      ...
      <div className="px-6 pt-6 pb-4 border-b border-[#1a1a1a]">
        <h1 className="text-2xl font-bold text-white mb-1">Atlas Block Explorer</h1>
        <p className="text-sm text-gray-500 mb-4">Search blocks, transactions, accounts, and more across the Atlas Sphere network.</p>
