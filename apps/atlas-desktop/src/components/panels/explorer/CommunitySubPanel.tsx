...
const projects = [
  ...
  { name: 'Atlas Wallet', category: 'Wallet', description: 'Official browser extension wallet with unified EVM/SVM balance view.', logo: '👛' },
...
const events = [
  { date: 'Feb 15, 2026', title: 'Atlas Developer Summit', type: 'Conference', location: 'San Francisco, CA', link: '#' },
  ...
  { date: 'Mar 18, 2026', title: 'Atlas Community Call #24', type: 'Community', location: 'Discord / YouTube', link: '#' },
...
const topics = [
  ...
  { title: 'ATLAS tokenomics discussion - staking rewards adjustment', category: 'Tokenomics', replies: 156, lastActivity: '30m ago' },
  ...
  { title: 'Tutorial request: ZK proofs on Atlas Sphere', category: 'Requests', replies: 19, lastActivity: '12h ago' },
  { title: 'Performance benchmarks: Atlas vs Solana vs Ethereum L2s', category: 'Research', replies: 67, lastActivity: '3h ago' },
];

const grants = [
  { title: 'Core Infrastructure Grant', amount: '$50,000 – $250,000', deadline: 'Mar 31, 2026', requirements: 'Open-source tooling, SDKs, or core protocol improvements that benefit the entire Atlas ecosystem.', status: 'Open' },
  ...
  { title: 'Community Education Grant', amount: '$5,000 – $25,000', deadline: 'Ongoing', requirements: 'Tutorials, documentation, video content, or educational programs for the Atlas developer community.', status: 'Open' },
