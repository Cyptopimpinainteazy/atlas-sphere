  ...
  return (
    <div className="overflow-y-auto h-full bg-gradient-to-b from-slate-900 via-[#0a100e] to-black text-white p-6 space-y-8">
      ...
      <div>
        ...
        <p className="text-slate-400 text-sm mt-1">How Atlas Sphere keeps your assets safe</p>
      </div>
      ...
      <div className="bg-slate-800/40 border border-slate-700/50 rounded-xl p-5">
        ...
        <div className="flex items-center gap-2 text-emerald-400">
          ...
          <span className="font-medium">security@atlas-sphere.io</span>
        </div>
      </div>
