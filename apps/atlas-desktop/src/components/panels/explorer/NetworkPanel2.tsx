...
const sectionCards = [
  ...
  {
    title: "RPC Providers",
    desc: "Connect your dApp to Atlas Sphere with reliable RPC endpoints.",
    icon: Server,
...
const dataIndexers = [
  {
    name: "X3 Indexer",
    desc: "Native indexing service for Atlas Sphere data.",
    status: "active",
  },
  {
    name: "SubQuery",
    ...
    <div className="overflow-y-auto h-full bg-slate-900 text-white p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1">
          Atlas Sphere network resources and infrastructure
        </p>
      </div>
