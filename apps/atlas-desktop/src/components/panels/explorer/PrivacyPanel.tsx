      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            Atlas Sphere (&ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;) is committed to protecting your
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            Transactions on the Atlas Sphere blockchain are public and transparent by design. This includes wallet
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-orange-400 font-medium">privacy@atlas-sphere.io</p>
        </section>
