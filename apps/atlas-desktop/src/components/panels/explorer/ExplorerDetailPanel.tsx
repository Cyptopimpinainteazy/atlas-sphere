...
const MOCK_BLOCK = {
  ...
  extrinsics: [
    ...
    { index: 1, hash: '0xext002...c3d4', module: 'Balances', call: 'transfer(5FHne..., 1500 ATLAS)', status: 'Success' },
...
const MOCK_TX = {
  ...
  events: [
    { name: 'Balances.Transfer', data: 'from: 5Grwv... → to: 5FHne... amount: 1500 ATLAS' },
    { name: 'System.ExtrinsicSuccess', data: 'weight: 234,567' },
    { name: 'Treasury.Deposit', data: 'fee: 0.0012 ATLAS' },
  ],
};

const MOCK_ACCOUNT = {
  address: '5GrwvaEF5zXb26Fz9rcQpDWS57CtERHpNehXCPcNoHGKutQY',
  freeBalance: '45,230.5 ATLAS',
  reserved: '1,200.0 ATLAS',
  nonce: 847,
  transactionCount: 1243,
  recentTxs: [
    { hash: '0xaaa...111', type: 'Send', amount: '1,500 ATLAS', to: '5FHne...', time: '2m ago' },
    { hash: '0xbbb...222', type: 'Receive', amount: '3,200 ATLAS', from: '5DAng...', time: '15m ago' },
    { hash: '0xccc...333', type: 'Send', amount: '500 ATLAS', to: '5HGjW...', time: '1h ago' },
    { hash: '0xddd...444', type: 'Stake', amount: '10,000 ATLAS', to: 'Validator Pool', time: '3h ago' },
    { hash: '0xeee...555', type: 'Receive', amount: '892.4 ATLAS', from: '5Ckxo...', time: '6h ago' },
  ],
};
