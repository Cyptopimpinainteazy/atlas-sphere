...
const steps = [
  {
    ...
    description:
      "Install Rust, Node.js, and the Atlas CLI. Clone the repository and configure your local development workspace.",
  },
  {
    number: 2,
    title: "Run a Node",
    ...
    description:
      "Start a local Atlas Sphere node in development mode. Connect to the testnet and verify block production is working.",
  },
  {
    number: 3,
    ...
    <div className="overflow-y-auto h-full bg-gradient-to-b from-slate-900 via-[#0c0818] to-black text-white p-6 space-y-10">
      ...
      <div className="space-y-2">
        ...
        <p className="text-slate-400 text-sm max-w-xl">
          Follow these four steps to set up your environment through deploying your first contract on X3 Atlas Chain.
        </p>
      </div>
