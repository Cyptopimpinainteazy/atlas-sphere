...
const categories = [
  {
    ...
    desc: "Foundational blockchain components powering the Atlas Sphere ecosystem.",
    icon: Server,
    gradient: "from-emerald-600 to-green-600",
    stats: { label: "TVL", value: "$420M" },
    items: ["Atlas Kernel", "Consensus Engine", "RPC Gateway", "State Indexer"],
  },
  {
    name: "DeFi Protocols",
...
const supportedChains = [
  ...
  { name: "X3 Atlas Sphere", color: "bg-orange-500" },
];
    ...
    <div className="overflow-y-auto h-full bg-slate-900 text-white p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1">
          Explore the Atlas Sphere ecosystem and its components
        </p>
      </div>
