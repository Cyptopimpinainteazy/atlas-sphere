...
export const sampleNetworkControlData: NetworkControlData = {
  peers: [
    ...
    {
      id: "peer-6",
      addr: "relay.atlas-sphere.io:443",
      protocol: "ws",
      latencyMs: 33,
      status: "connected",
      lastSeenSeconds: 2,
  ...
  logs: [
    { ts: "14:37:12", level: "info", message: "Peer atlas-gpu-0 connected (tcp)" },
...
export const sampleIdeTelemetryData: IdeTelemetryData = {
  builds: [
    { id: "b-1", target: "atlas-sphere-runtime", status: "success", durationSeconds: 142, timestamp: "14:28:03" },
    { id: "b-2", target: "x3-lang-stdlib v0.3.0", status: "building", durationSeconds: 0, timestamp: "14:32:18" },
  ],
  contracts: [
    { name: "HTLC_v2", address: "5GrwvaEF...43jS", network: "atlas-testnet", status: "deployed", gasUsed: 2_480_000 },
    { name: "GovernanceProxy", address: "5FHneW46...8qPm", network: "atlas-testnet", status: "deployed", gasUsed: 1_120_000 },
  ],
  traces: [
  ...
  logLines: [
    "Compiling atlas-sphere-runtime v0.8.2",
