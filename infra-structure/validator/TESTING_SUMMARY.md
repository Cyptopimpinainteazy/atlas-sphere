...
| `docs/E2E_SECURITY_TESTING.md` | Full documentation | 300+ lines of testing guide, invariants, debugging |
...
- [Full E2E Security Testing Guide](docs/E2E_SECURITY_TESTING.md)
...
3. Check [E2E_SECURITY_TESTING.md](docs/E2E_SECURITY_TESTING.md) for detailed documentation
