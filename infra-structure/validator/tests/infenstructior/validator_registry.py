...
2. Get API keys for Infenstructior access
...
AUTH_SALT = "atlas-sphere-infenstructior-2026"  # Change in production!
JWT_SECRET = "infenstructior-jwt-secret-change-me"  # Must match .env
