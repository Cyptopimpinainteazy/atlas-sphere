# Infenstructior Quick Reference
...
| `docs/INFENSTRUCTIOR_300X_TEST_PLAN.md` | Full test spec |
...
./tps_infenstructior_adapter --workers 2000 --batch-size 2000
```
...
- Docs: `docs/INFENSTRUCTIOR_300X_TEST_PLAN.md`
- README: `README.md`
