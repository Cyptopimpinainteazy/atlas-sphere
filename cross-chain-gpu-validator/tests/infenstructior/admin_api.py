#!/usr/bin/env python3
"""
Infenstructior Admin API — Comprehensive Admin Dashboard Backend
...
# ── Configuration ──────────────────────────────────────────
ADMIN_PASSWORD = os.environ.get("ADMIN_PASSWORD", "infenstructior-admin")
ADMIN_JWT_SECRET = os.environ.get(
    "ADMIN_JWT_SECRET", "infenstructior-admin-jwt-secret-2024"
)
...
class AdminCommandRunner:
    ...
    COMMANDS = {
        ...
        "stop-all": {
            ...
            "category": "services",
            "description": "Kills all Infenstructior services",
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("  Infenstructior Admin API")
