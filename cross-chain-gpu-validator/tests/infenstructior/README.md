# Infenstructior 300× Solana Test Suite

**Complete testing infrastructure** for proving that external validators can achieve 300× Solana throughput using Infenstructior's GPU-accelerated cross-chain validator superhighway.

## 🚀 NEW: External Validator Onboarding

**Infenstructior is now open for external validators!** Any chain can plug in and get 300× speed with authenticated API access.

### ⚡ Quick Start for External Validators

```bash
# 1. Start all services
./start_infenstructior.sh
...
Integrated with JWT-based authentication from [AUTHENTICATION_SETUP.md](../../../AUTHENTICATION_SETUP.md):
...
│   ├── start_infenstructior.sh    # NEW: Start all services
│   ├── stop_infenstructior.sh     # NEW: Stop all services
│
...
│
├── 🧪 TESTING
│   ├── tps_infenstructior_adapter.go  # Go adapter for existing TPS tester
...
```bash
cd cross-chain-gpu-validator/tests/infenstructior
...
The **Go TPS adapter** bridges your existing `Blockchain-TPS-Test-GO` tool with the Infenstructior lanes:

```bash
cd "TPS TESTING/infenstructior"

# Build adapter
go build -o tps_infenstructior_adapter tps_infenstructior_adapter.go

# Run with custom settings
./tps_infenstructior_adapter \
  --target-tps 19500000 \
  --duration 600 \
...
1. **Always have native fallback** - If Infenstructior fails, validator continues natively
...
# Results in tests/infenstructior/results/<timestamp>/
```
...
- **Full Test Plan:** [docs/INFENSTRUCTIOR_300X_TEST_PLAN.md](../../docs/INFENSTRUCTIOR_300X_TEST_PLAN.md)
- **Root Repo README:** [../../../README.md](../../../README.md)
- **GPU Validator README:** [../../README.md](../../README.md)
- **TPS Testing (Go):** [../../../TPS TESTING/README.md](../../../TPS%20TESTING/README.md)
