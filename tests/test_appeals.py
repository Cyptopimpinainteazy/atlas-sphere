...
from swarm.jury.appeals import AppealsManager, AppealGround, AppealState
...
def test_jury_decision_consumes_tokens():
    ...
    votes = {j: True for j in jurors}  # All vote to affirm
...
def test_reversal_creates_precedent():
    ...
    # Record reversal
    votes = {j: False for j in jurors}  # All vote to reverse
    am.record_jury_decision(
        appeal_id=appeal.appeal_id,
        jury_session_id="jury-001",
