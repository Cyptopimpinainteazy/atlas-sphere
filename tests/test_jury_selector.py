...
import pytest
from swarm.jury.selector import JurySelector, JuryPool
from swarm.jury.jury_types import JuryType, JuryDomain, JurySizer
...
class TestJurySelector:
    ...
    def test_insufficient_agents_raises(self, agent_pool):
        ...
        # Keep only 2 agents
        small_pool = {
            k: v for k, v in list(agent_pool.items())[:2]
        }
