...
class TPSDashboard:
            ...
            for table in tables:
                for record in table.records:
                    data_points.append({
                        ...
                        "block_height": record["block_height"] if "block_height" in record else None,
                        "transaction_count": record["transaction_count"] if "transaction_count" in record else None,
    ...
    def render_tps_chart(self, df: pd.DataFrame):
        ...
        fig.add_trace(go.Scatter(
            ...
            line=dict(color="rgb(118, 75, 162)", width=2, dash="dash")
        ))
