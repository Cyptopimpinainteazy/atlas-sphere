...
#   source /path/to/atlas-boot-config.sh
...
alias beast-login="echo 'Username: admin'; echo 'Password: atlas-sphere-2026'; echo 'Dashboard: http://localhost:5173'"
...
echo "✓ Atlas Sphere boot commands loaded!"
echo ""
