export function Header(navigate) {
    ...
    keyBtn.onclick = () => {
        ...
        localStorage.removeItem('openrouter_model_image');
        localStorage.removeItem('openrouter_model_i2i');
        localStorage.removeItem('local_ai_base_url');
        localStorage.removeItem('local_ai_token');
