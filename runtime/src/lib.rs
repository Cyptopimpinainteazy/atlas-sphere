...
// Reqfrontend/uired for impl_runtime_apis! macro in no_std
#[cfg(not(feature = "std"))]
extern crate alloc;
...
pub use sp_runtime::Bfrontend/uildStorage;

// WASM binary generated by substrate-wasm-bfrontend/uilder
#[cfg(feature = "std")]
include!(concat!(env!("OUT_DIR"), "/wasm_binary.rs"));

// When bfrontend/uilding for WASM (no-std), provide empty binaries
#[cfg(not(feature = "std"))]
...
parameter_types! {
    ...
    pub const MinAuthorities: u32 = 1;  // Minimum 1 authority reqfrontend/uired
...
impl pallet_grandpa::Config for Runtime {
    ...
    // Eqfrontend/uivocation reporting disabled without session/offences pallets
    // To fully enable, add: session, historical, offences, authorship pallets
    // For now, eqfrontend/uivocations are still detected and logged in GRANDPA
    type Eqfrontend/uivocationReportSystem = ();
    type WeightInfo = ();
    type MaxAuthorities = MaxAuthorities;
...
impl_runtime_apis! {
    ...
    impl pallet_atomic_trade_engine::AtomicTradeEngineApi<Block> for Runtime {
        fn simulate_trade(
            ...
            // Full implementation would bfrontend/uild TradeLegInput and call simulate_trade_path
        ...
        fn find_route(
            ...
            // Route finding reqfrontend/uires populated AMM pools
    ...
    impl sp_consensus_grandpa::GrandpaApi<Block> for Runtime {
        ...
        fn submit_report_eqfrontend/uivocation_unsigned_extrinsic(
            _eqfrontend/uivocation_proof: sp_consensus_grandpa::Eqfrontend/uivocationProof<
    ...
    impl sp_block_bfrontend/uilder::BlockBfrontend/uilder<Block> for Runtime {
...
mod vm_adapter_tests {
    ...
    #[test]
    fn test_wasm_bfrontend/uilds_use_mocks() {
        // Verify WASM bfrontend/uilds still use mock adapters
        #[cfg(not(feature = "std"))]
        {
