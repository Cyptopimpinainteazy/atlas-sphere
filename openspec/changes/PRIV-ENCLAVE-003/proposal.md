...
- Atlas validators already run these GPUs; CC mode is a firmware toggle.
...
| Feature | Atlas (with this proposal) | Solana | Monad | Rollups |
|---------|---------------------------|--------|-------|---------|
...
|---|---|
| `pallets/atlas-kernel/` | Route private TXs to confidential pipeline |
