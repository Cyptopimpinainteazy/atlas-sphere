...
inputDocuments: ["_bmad-output/planning-artifacts/product-brief-atlas-sphere-master-2026-02-13.md", "_bmad-output/planning-artifacts/prd.md", "_bmad-output/planning-artifacts/ux-design-specification.md"]
workflowType: 'architecture'
project_name: 'atlas-sphere-master'
user_name: 'Lojak'
date: '2026-02-13'
---

# Architecture Decision Document - atlas-sphere-master
...
### Project Overview
**Atlas Sphere** is a multi-chain decentralized computing and finance platform built on Substrate with:
...
```
┌─────────────────┐     ┌─────────────────┐     ┌─────────────────┐
│  Price Oracles │────▶│  Atlas Sphere   │◀────│  Wallet Providers │
...
|--------------|------------------|------|
| Multi-Chain Wallet | `apps/atlas-desktop/` | Frontend |
