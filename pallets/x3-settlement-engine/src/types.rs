...
#[derive(
    Clone, Copy, Encode, Decode, RuntimeDebug, TypeInfo, MaxEncodedLen, PartialEq, Eq, Default,
)]
...
#[derive(
    Clone, Copy, Encode, Decode, RuntimeDebug, TypeInfo, MaxEncodedLen, PartialEq, Eq, Hash, Default,
)]
