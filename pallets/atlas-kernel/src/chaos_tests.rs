//! # Atlas Kernel Chaos Tests
//!
//! Adversarial tests designed to break invariants and find edge cases.
//! These tests simulate attacker behavior against the Atlas Kernel.
//!
//! ## Test Categories
//!
...
//!
//! Run with: `cargo test --package pallet-atlas-kernel --lib chaos_tests`
